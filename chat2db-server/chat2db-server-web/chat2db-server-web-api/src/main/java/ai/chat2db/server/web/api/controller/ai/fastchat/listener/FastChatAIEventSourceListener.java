...
public class FastChatAIEventSourceListener extends EventSourceListener {
    ...
    public FastChatAIEventSourceListener(SseEmitter sseEmitter, String uid) {
    ...
    private void saveAssistantResponse() {
        ...
        try {
            ...
            if (messages != null) {
                ...
                log.info("FastChatAI saved assistant response to cache, uid={}, history size={}", uid, messages.size());
            }
        } catch (Exception e) {
