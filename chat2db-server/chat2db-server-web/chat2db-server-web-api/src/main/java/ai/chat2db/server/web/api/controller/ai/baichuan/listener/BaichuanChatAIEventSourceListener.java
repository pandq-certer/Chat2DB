...
public class BaichuanChatAIEventSourceListener extends EventSourceListener {
    ...
    public BaichuanChatAIEventSourceListener(SseEmitter sseEmitter, String uid) {
    ...
    private void saveAssistantResponse() {
        ...
        try {
            ...
            if (messages != null) {
                ...
                log.info("BaichuanAI saved assistant response to cache, uid={}, history size={}", uid, messages.size());
            }
        } catch (Exception e) {
